      ...
      <div className="">
        ...
        <div className="bg-[#252525] px-2 rounded-b-2xl w-[400px] lg:w-[210px]">
          <div className="flex gap-3 lg:gap-2 px-6 py-2">
            <h1 className="text-3xl lg:text-xl text-white font-bold">{text1}</h1>
          ...
          <div className="flex lg:flex-row gap-5 px-3">
            <div className="mt-0">
              <p className="text-[#9A9A9A] text-2xl  lg:text-sm font-bold">{text2}</p>
              <p className="lg:text-[12px] text-[20px] text-white font-bold mb-5 mt-1">{text3}</p>
            </div>
            <div>
              <p className="text-[#9A9A9A] text-2xl  lg:text-sm font-bold">{text4}</p>
              <p className="lg:text-[12px] text-[20px] text-white font-bold mb-5 mt-1">{text5}</p>
            </div>
          </div>
        </div>
      </div>
